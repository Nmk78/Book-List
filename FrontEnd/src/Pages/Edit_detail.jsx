...
const EditDetail = ({ books }) => {
  ...
  return (
          <div className="p-5 flex flex-col lg:flex-row h-full justify-center items-center">
            <div className=" felx flex-col w-full justify-center items-center lg:w-1/3 lg:h-3/4 lg:justify-self-start lg:flex lg:items-center self-start bg-white">
              <a href="/books">
                <img
                  src={edit}

...
const Create = () => {
  ...
  let [book_number, setBook_number] = useState("");
  let [got_by, setGot_by] = useState("");
  let [translated, setTranslate] = useState(false);
  let [translator, setTranslator] = useState("");
          ...
          <div className="grid md:grid-cols-2 md:gap-6">
            ...
            <div className="relative z-0 w-full mb-6 group">
              <input
                ...
                placeholder=" "
                required=""
                onChange={(e) => setGot_by(e.target.value)}
                value={got_by}
              />
              <label
                htmlFor="got_by"
